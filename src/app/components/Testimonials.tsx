...
const GlobalSOC = () => {
  ...
  // URLs for desktop and mobile versions
  const desktopMapUrl = 'https://attackmap.sonicwall.com/live-attack-map/';
  const mobileMapUrl = 'https://attackmap.sonicwall.com/live-attack-map/?mobile=true'; // assuming mobile version uses this param; adjust if different
      ...
      <div className="relative z-10 w-full max-w-screen-xl mx-auto px-4">
        ...
        >
          ...
          <div className="lg:col-span-2 h-full bg-black/20 p-0 rounded-lg border border-white/10 overflow-hidden">
            <iframe
              src={isMobile ? mobileMapUrl : desktopMapUrl}
              title="SonicWall Live Attack Map"
